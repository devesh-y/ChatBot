...
import {getCookie, setCookie} from "@/utilities/getSetCookie.ts";
...
import {HandleLogin} from "@/utilities/HandleLogin.ts";
export const LoginPage=()=>{
    ...
    return <div className={"flex justify-center items-center h-full "}>
             <Card className="px-5 pb-10 pt-5  bg-transparent backdrop-blur-xl w-full  sm:max-w-[400px]  border-none shadow-[0_0_1.5px_0_white]">
            <CardHeader className={"mb-4"}>
                <CardTitle className={"font-bold text-blue-700"}>Signup/Login</CardTitle>
            </CardHeader>
